...
<head>
  ...
  <title>About WoodCraft | WoodCraft Care</title>
...
<body class="bg-[#F3F0E4] text-gray-900 min-h-screen flex flex-col">
  ...
  <main class="flex-1 max-w-3xl w-full mx-auto px-6 py-16">
    ...
    <div class="bg-white rounded-3xl border border-gray-100 shadow-sm p-10">
      ...
      <h1 class="font-serif text-3xl font-semibold text-gray-900 mb-4">About WoodCraft</h1>
      <div class="text-gray-600 text-[15px] leading-relaxed space-y-4">
        <p>WoodCraft has been handcrafting solid wood furniture and home décor for over two decades. Every piece is built to last, using sustainably sourced materials and time-tested joinery techniques.</p>
        <p>WoodCraft Care is our dedicated support hub, built to make it easy for customers to get help with orders, warranty claims, and returns.</p>
      </div>
